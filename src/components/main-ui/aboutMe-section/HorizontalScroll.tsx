...
const cards = [
  {
    ...
    description: 'أبني أنظمة قابلة للتوسع وحلولاً رقمية تركز على حل المشكلة قبل كتابة أول سطر برمجي.',
    bg: '#252422',
    text: '#FFFCF2',
    accent: '#EB5E28',
  },
  {
    ...
    description: 'أطور نماذج تعتمد على البيانات والذكاء الاصطناعي مع التركيز على الشفافية وقابلية التفسير.',
    bg: '#403D39',
    text: '#FFFCF2',
    accent: '#EB5E28',
  },
  {
    ...
    description: 'أحول الأفكار إلى منتجات حقيقية من الفكرة الأولى وحتى الإطلاق والتجربة مع المستخدمين.',
    bg: '#EB5E28',
    text: '#FFFCF2',
    accent: '#FFFCF2',
  },
  {
    ...
    description: 'أبحث عن التحديات التشغيلية وسلوك المستخدم ثم أبني حلولاً عملية تحقق أثراً قابلاً للقياس.',
    bg: '#1C1B18',
    text: '#FFFCF2',
    accent: '#EB5E28',
  },
  {
    ...
    description: 'أؤمن بأن التقنية وسيلة لصناعة أثر حقيقي والمساهمة في التحول الرقمي للمملكة.',
    bg: '#F5F0E8',
    text: '#252422',
    accent: '#EB5E28',
  },
...
export default function HorizontalScroll(): JSX.Element {
  ...
  useEffect(() => {
    ...
    if (ulRef.current && items && items.length > 0 && containerRef.current) {
      ...
      const controls = animate(ulRef.current, { x: xKeyframes }, { ease: 'linear' });
  ...
  return (
    <section ref={containerRef} className="h-[700vh] w-full mx-auto my-auto relative bg-[#1a1a1a]">
      <div className="sticky top-0 h-screen w-full overflow-hidden">
                <div dir="rtl" className="absolute top-0 left-0 w-full h-1.5 bg-white/10 z-50">
          <div 
            ref={progressBarRef} 
            className="h-full bg-[#EB5E28] origin-right" 
          />
        </div>
        <div dir="rtl" className="absolute top-12 right-8 md:right-16 z-40 flex flex-col items-center gap-3 pointer-events-none">
        ...
        <ul ref={ulRef} className="flex justify-start items-center h-full w-max">
          {cards.map((card) => (
            <li
              key={card.title}
              className="h-[85vh] md:h-[90vh] w-screen flex-shrink-0 relative overflow-hidden px-4 md:px-12 flex items-center justify-center"
            >
              <div 
              ...
              >
                ...
                <div dir="rtl" className="absolute inset-0 flex flex-col justify-between p-8 md:p-16 lg:p-24 z-10">
                  ...
                  <div className="flex items-center justify-between font-mono">
                    <span
                      ...
                      style={{ opacity: 0.6 }}
                    >
                      {String(total).padStart(2, '0')} / <span className="font-bold opacity-100">{card.num}</span>
                    </span>
                    <span
